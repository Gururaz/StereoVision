...
# https://github.com/savnani5/Depth-Estimation-using-Stereovision/tree/9fc691c27a3f7c3d525872e385a86c82a6b836e8
...
def ssd_correspondence(img1, img2):
    ...
    plt.imshow(disparity_map_scaled)
    plt.colorbar()
    plt.axis('off')
    plt.show()
